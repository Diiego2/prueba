...
function animacion (e){
    ...
    var x = Math.round(Math.sin(angulo)*4);
    var y = Math.round(Math.cos(angulo)*6);
    lienzo.beginPath();
    ...
    lienzo.arc(x+220,y+150,10,0,Math.PI*2, false);
    lienzo.moveTo(x+50,y);
    lienzo.arc(x+270,y+150,10,0,Math.PI*2, false);
    lienzo.fill();
}
